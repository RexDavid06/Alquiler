"""Management command to generate and send lease expiry notifications.
...
Usage:
    python manage.py send_lease_notifications
    python manage.py send_lease_notifications --today 2026-09-04
    python manage.py send_lease_notifications --send-emails
"""

from django.core.management.base import BaseCommand

from notifications.services import generate_lease_notifications, send_notification_email
from notifications.models import Notification, NotificationChannel, NotificationStatus


class Command(BaseCommand):
    help = 'Generate lease expiry notifications for eligible leases.'
    ...
    def handle(self, *args, **options):
        ...
        result = generate_lease_notifications(today=today_override)
        self.stdout.write(
            self.style.SUCCESS(
                f"Lease notifications: created={result['created']}, "
